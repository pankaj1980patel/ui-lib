...
const IconGoogleColorful = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <g clipPath="url(#a)">
      <path
        fill="#4285F4"
        d="M23.766 12.277c0-.816-.066-1.636-.207-2.439H12.24v4.621h6.482a5.554 5.554 0 0 1-2.399 3.647v2.998h3.867c2.271-2.09 3.576-5.177 3.576-8.827Z"
      />
      <path
        fill="#34A853"
...
export default IconGoogleColorful;
